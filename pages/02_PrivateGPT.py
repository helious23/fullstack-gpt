...
prompt = ChatPromptTemplate.from_template(
    """
    Answer the question using ONLY the following context and not your traning data. If you don't know the answer just say you don't know. DO NOT make anything up.
